...
exports.default = {
  isTrue: isTrue, isFalse: isFalse, typeOf: typeOf, notTypeOf: notTypeOf, isLess: isLess, isMore: isMore, instanceOf: instanceOf, notInstanceOf: notInstanceOf, isObject: isObject, isNotObject: isNotObject,
  isEmpty: isEmpty, isNotEmpty: isNotEmpty, isArray: isArray, isNotArray: isNotArray, isString: isString, isNotString: isNotString, isNumber: isNumber, isNotNumber: isNotNumber, isBoolean: isBoolean,
  isNotBoolean: isNotBoolean, isNull: isNull, isNotNull: isNotNull, isUndefined: isUndefined, isDefined: isDefined, isFunction: isFunction, isNotFunction: isNotFunction, include: include,
  notInclude: notInclude, lengthOf: lengthOf, match: match, notMatch: notMatch, isNaN: checkNaN, isNotNaN: isNotNaN, operator: operator, closeTo: closeTo,
  sameMembers: sameMembers, includeMembers: includeMembers, oneOf: oneOf, property: property, notProperty: notProperty
};
...
function propType(wrapper, propName, value, msg) {
  this.equal(_typeof(wrapper.prop(propName)), value, msg);
}
...
exports.default = {
  ...
  checkKey: checkKey, checkName: checkName, prop: prop, propType: propType, state: state, text: text, type: type, containsAnyMatchingElements: containsAnyMatchingElements,
